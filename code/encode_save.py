import numpy as np
import pandas as pd
from ir_models.dense import TctColbert
import ir_datasets
import os
...
def encode_and_save_documents(doc_texts, doc_ids, memmap_path, csv_map_path):
    # 实例化模型
    model = TctColbert(model_hgf='castorini/tct_colbert-v2-msmarco')
...
if __name__ == "__main__":
    ...
    # 输出路径（可根据项目结构调整）
    memmap_path = "code/data/memmap/msmarco-passages/TctColbert/TctColbert.dat"
    csv_map_path = "code/data/memmap/msmarco-passages/TctColbert/TctColbert_map.csv"
